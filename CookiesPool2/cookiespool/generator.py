...
class CookiesGenerator(object):
    ...
    def init_browser(self):
        ...
        if BROWSER_TYPE == 'PhantomJS':
            ...
            print('3,self.browser=======================:',self.browser)
            self.browser.set_window_size(1400, 500)
            print('1,self.browser=========================:', type(self.browser))
        elif BROWSER_TYPE == 'Chrome':
            self.browser = webdriver.Chrome()
            print('2,elf.browser=========================:',type(self.browser))
    ...
    def close(self):
        ...
        """
        try:
            print('Closing Browser > 关闭浏览器 >')
            self.browser.close()
            del self.browser
        except TypeError:
            print('Browser not opened > 浏览器没有打开 >')
